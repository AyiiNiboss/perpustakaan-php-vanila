...
<?php
    ...
    if (isset ($_POST['Simpan'])){
        ...
        $sql_simpan1 = "INSERT INTO tb_tpeminjaman (id_sk,id_buku,id_anggota,jumlah_buku,tgl_pinjam,status,tgl_kembali) VALUES (
			'".$_POST['id_sk']."',
		   '".$_POST['id_buku']."',
		   '".$_POST['id_anggota']."',
		   '".$_POST['jumlah_buku']."',
		 ...
		 $sql_simpan2 = "INSERT INTO log_pinjam (id_buku,id_anggota,tgl_pinjam) VALUES (
			 '".$_POST['id_buku']."',
			 '".$_POST['id_anggota']."',
			 '".$_POST['tgl_pinjam']."')";   
    ...
    if ($query1 && $query2){
      ...
      Swal.fire({title: 'Tambah Data Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
          ...
          if (result.value) {
              window.location = 'index.php?hal=tambah_sirkulasi';
          }
      })</script>";
    }
  }
