...
<section class="content">
	<div class="box box-primary">
		<div class="box-header with-border">
			<a href="export/pdfpeminjaman.php" title="Tambah Data" class="btn btn-success">
				<i class="fa fa-file-pdf-o"></i>  Export PDF</a>
			<a href="export/excelpeminjaman.php" title="Tambah Data" class="btn btn-warning">
			...
			<div class="table-responsive">
				...
				if(isset($_POST['filter_tgl'])){
					...
					if($mulai != null || $selesai != null){					
						$query =mysqli_query($koneksi,"SELECT * from tb_peminjaman where tgl_pinjam BETWEEN '$mulai' and DATE_ADD('$selesai',INTERVAL 1 DAY) order by id_pinjam DESC");
					}else{
